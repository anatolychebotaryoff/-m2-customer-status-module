<?php
/**
 * Override Mage_Sales_Model_Order_Api_V2 to add delivery_interval to api request for sales order info call
 *
 * @category  Lyons
 ...
 */ 
class Lyonscg_Sales_Model_Order_Api_V2 extends Mage_Sales_Model_Order_Api_V2
{
    /**

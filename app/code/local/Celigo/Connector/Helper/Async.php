...
class Celigo_Connector_Helper_Async extends Mage_Core_Helper_Abstract {
    ...
    /** @var Celigo_Connector_Model_Asyncconnection */
    ...
    private function getConnection() {
        if (!$this->_connection) {
            $this->_connection = Mage::getSingleton('connector/asyncconnection');
        }

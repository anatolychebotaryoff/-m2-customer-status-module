 ...
 *
 * @category    Celigo
 * @package     Celigo_Connectorplus
 * @copyright   Copyright (c) 2012 Magento Inc. (http://www.magentocommerce.com)
 * @license     http://opensource.org/licenses/osl-3.0.php  Open Software License (OSL 3.0)
 */
Mage::log('Connector Plus installer - START', Zend_Log::DEBUG, 'connectorplus-install.log', true);
$installer = $this;
...
try {
    ...
    Mage::log('cancelled_in_netsuite field added to sales_order table', Zend_Log::DEBUG, 'connectorplus-install.log', true);
    ...
    Mage::log('is_imported field added to sales_creditmemo table', Zend_Log::DEBUG, 'connectorplus-install.log', true);
}
catch(Exception $e) {
    try {
        ...
        Mage::log($e->getMessage() , Zend_Log::ERR, 'connectorplus-install.log', true);
    }
}
$installer->endSetup();
Mage::log('Connector Plus installer - END', Zend_Log::DEBUG, 'connectorplus-install.log', true);

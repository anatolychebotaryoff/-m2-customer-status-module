...
class Celigo_Connectorplus_Model_Sales_Orders_Api extends Mage_Api_Model_Resource_Abstract {
    ...
    public function create($orderData) {
        ...
        $quote = Mage::getModel('sales/quote')->setStoreId($store->getId())->load(null);
    ...
    public function update($flag, $data) {
        ...
        $creditMemoApiModel = Mage::getModel('connectorplus/sales_order_creditmemo_api');

...
class USWF_AirMerv_Adminhtml_MultiproductsController extends Mage_Adminhtml_Controller_Action
{
    /**
    ...
    public function chooserAction()
    {
        ...
        $productsGrid = $this->getLayout()->createBlock('uswf_airmerv/adminhtml_catalog_product_widget_chooser', '', array(
            'id'                => $uniqId,

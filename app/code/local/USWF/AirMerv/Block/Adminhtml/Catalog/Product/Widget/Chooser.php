...
class USWF_AirMerv_Block_Adminhtml_Catalog_Product_Widget_Chooser extends Mage_Adminhtml_Block_Catalog_Product_Widget_Chooser {
...
';
    ...
    protected function _prepareCollection() {
        ...
        $collection = Mage::getResourceModel('catalog/product_collection')
                ...
                ->addAttributeToSelect('merv')
                ->addAttributeToFilter('merv', array('notnull' => True));
    ...
    protected function _prepareColumns() {
        ...
        $this->addColumn('size_advertised', array(
            'header' => Mage::helper('catalog')->__('Advertised Size'),
            'name' => 'chooser_size_advertised',
            'index' => 'size_advertised',
            'options' => $this->_getAttributeOptions('size_advertised'),
            'type' => 'options'
        ));
        $this->addColumn('chooser_merv', array(
            'header' => Mage::helper('catalog')->__('MERV'),
            'name' => 'chooser_merv',
            'type' => 'options',
            'options' => $this->_getAttributeOptions('merv'),
            'index' => 'merv'
        ));

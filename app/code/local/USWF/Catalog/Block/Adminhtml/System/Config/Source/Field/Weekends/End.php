...
class USWF_Catalog_Block_Adminhtml_System_Config_Source_Field_Weekends_End
    extends Mage_Adminhtml_Block_System_Config_Form_Field_Array_Abstract
{
    ...
    public function _prepareToRender()
    {
        $this->addColumn('day', array(
            ...
            'label' => Mage::helper('adminhtml')->__('Last Day'),
            'style' => 'width:75px',
        ));
        $this->addColumn('time', array(
            'renderer' => $this->_getTimeRenderer(),
            'label' => Mage::helper('adminhtml')->__('Last Time'),
            'style' => 'width:100px',
        ));

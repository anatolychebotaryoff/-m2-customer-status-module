...
class Magestore_Storelocator_Adminhtml_Importcontroller extends Mage_Adminhtml_Controller_Action {
    ...
    public function saveAction() {
        ...
        if (!empty($_FILES['csv_store']['tmp_name'])) {
            ...
            $this->_redirect('storelocatoradmin/adminhtml_storelocator/index');
        } else {
            Mage::getSingleton('adminhtml/session')->addError(Mage::helper('storelocator')->__('Invalid file upload attempt'));
    ...
    public function sampleAction() {
        $content = "Name,Status,Address,City,State,Country,Zipcode,Latitude,Longtitude,Fax,Phone,Email,Link,Zoom level,Image name,Tag store\rGiaytot.com,Enabled,\"311 Truong Chinh, Thanh Xuan\",Ha Noi,,VN,10000,21.0013632,105.8267324,,842000000000,,,12,,";
        $this->_prepareDownloadResponse('sample.csv', $content, 'text/csv');
    }

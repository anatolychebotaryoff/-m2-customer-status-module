        ...
        foreach ($groupPrices as $groupPrice) {
            if ($groupPrice['cust_group'] == $customerGroup) {
                if ($groupPrice['isfixed'] == 1 && $groupPrice['website_price'] < $finalPrice) {
                    $result = $groupPrice['website_price'];
                    break;
                } else if ($groupPrice['isfixed'] == 0 && ( $finalPrice - $finalPrice * ( $groupPrice['website_price'] / 100) ) < $finalPrice ) {
                    $result = $finalPrice - $finalPrice * ($groupPrice['website_price'] / 100);
                    break;
                }
            }
        }

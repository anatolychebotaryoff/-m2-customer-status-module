...
class Mage_Adminhtml_Block_Sales_Order_Create_Customer_Grid extends Mage_Adminhtml_Block_Widget_Grid
{
    ...
    public function __construct()
    {
        ...
        $this->setRowClickCallback('order.selectCustomerNew.bind(order)');
        $this->setUseAjax(true);
//Dot not use sort by, defaults purpose of limit and can load all data
//        $this->setDefaultSort('entity_id');
    ...
    protected function _prepareColumns()
    {
        ...
        $this->addColumn('store_id', array(
            'header'    =>Mage::helper('sales')->__('SignedId Up From'),
            'index'     =>'store_id',
            'column_css_class'=>'no-display store-id-data',

    ...
    implements Mage_Adminhtml_Block_Widget_Tab_Interface
{
    ...
    protected function _prepareLayout()
    {
        ...
        $urlString = 'adminhtml/cyberpaymentprofile/new';
    ...
    {
        return $this->getUrl('adminhtml/cyberpaymentprofile/edit', array('id' => $row->getId()));
    }
    ...
    {
        return $this->getUrl('adminhtml/cyberpaymentprofile/grid', array('_current' => true));
    }
    ...
    protected function _prepareMassaction()
    {
        ...
        $this->getMassactionBlock()->addItem('remove_profile', array(
            ...
            'url' => $this->getUrl('adminhtml/cyberpaymentprofile/massRemove'),

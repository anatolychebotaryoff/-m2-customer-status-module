...
class Cmsmart_Quickview_CartController extends Mage_Checkout_CartController
{
    /**
    ...
    protected function _goBack()
    {
        ...
        $urlold = Mage::helper('core/http')->getHttpReferer() ? Mage::helper('core/http')->getHttpReferer()  : Mage::getUrl();
        $baseurl = Mage::getUrl();
        ...
        if ($returnUrl) {
            ...
            $this->getResponse()->setRedirect($urlold);
        } else {

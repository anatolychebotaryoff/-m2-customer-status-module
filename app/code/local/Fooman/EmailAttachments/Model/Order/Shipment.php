...
{
    const XML_PATH_EMAIL_ENABLED_SEND_TRACKING_INFORMATION = 'sales_email/shipment/enabled_send_tracking_information';
    ...
    {
        if (!$this->canSendNewShipmentEmail($this->getOrder()->getStore()->getId())) {
            return $this;
        }
    ...
    public function sendUpdateEmail($notifyCustomer = true, $comment='')
    {
        ...
        //Lyonscg enazarov start[391751] add payment method to shipping comments email
        $paymentBlock   = Mage::helper('payment')->getInfoBlock($order->getPayment())
        //Lyonscg enazarov end[391751]
            ->setIsSecureMode(true);
        $mailTemplate = Mage::getModel('core/email_template');
    ...
    {
        return Mage::getStoreConfigFlag(self::XML_PATH_EMAIL_ENABLED_SEND_TRACKING_INFORMATION, $store);
    }

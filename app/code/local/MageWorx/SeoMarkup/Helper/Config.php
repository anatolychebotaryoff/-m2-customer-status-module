...
class MageWorx_SeoMarkup_Helper_Config extends Mage_Core_Helper_Abstract
{
    ...
    const XML_PATH_AVAILABILITY_ENABLED             = 'mageworx_seo/richsnippets/enable_availability';
    ...
    public function isRichsnippetAvailabilityEnabled() 
    {
        return (bool) Mage::getStoreConfigFlag(self::XML_PATH_AVAILABILITY_ENABLED);
    }

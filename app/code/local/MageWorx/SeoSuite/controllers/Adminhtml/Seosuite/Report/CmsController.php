 ...
 */
class MageWorx_Seosuite_Adminhtml_Seosuite_Report_CmsController extends Mage_Adminhtml_Controller_Action
{

    public function indexAction()
    {
        if (!Mage::helper('seosuite/report')->getCmsReportStatus()){
            ...
            case 'calculation':
                ...
                if ($current < $total) {
                    ...
                    if ($current >= $total) {
                        $current        = $total;
                        $result['stop'] = 1;
                        Mage::helper('seosuite/report')->setCmsReportStatus(1);
...
//        }
    ...
    {
        if (!Mage::helper('seosuite/report')->getCmsReportStatus()){
            Mage::getSingleton('adminhtml/session')->addWarning(Mage::helper('seosuite')->__('You need to generate the report due to recent changes.'));
        }

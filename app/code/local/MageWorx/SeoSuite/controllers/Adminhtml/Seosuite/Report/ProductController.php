 ...
 */
class MageWorx_Seosuite_Adminhtml_Seosuite_Report_ProductController extends Mage_Adminhtml_Controller_Action
{
    public function indexAction()
    {
        if (!Mage::helper('seosuite/report')->getProductReportStatus()) {
            ...
            case 'calculation':
                ...
                if ($current < $total) {
                    ...
                    if ($current >= $total) {
                        $current        = $total;
                        $result['stop'] = 1;
                        Mage::helper('seosuite/report')->setProductReportStatus(1);

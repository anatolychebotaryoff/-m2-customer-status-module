 ...
 */
class MageWorx_SeoSuite_Model_Richsnippet_Catalog_Product_Meta_Width extends MageWorx_SeoSuite_Model_Richsnippet_Catalog_Product_Abstract
{
    protected function _addAttributeForNodes(simple_html_dom_node $node)
    {
        $attributeCode = Mage::helper('seosuite/richsnippet')->getWidthAttributeCode();
        if($attributeCode){
    ...
    {
        $widthValue = Mage::helper('seosuite/richsnippet')->getAttributeValueByCode($this->_product, $attributeCode);

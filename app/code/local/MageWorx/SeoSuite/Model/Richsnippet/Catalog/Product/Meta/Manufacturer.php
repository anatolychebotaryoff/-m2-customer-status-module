 ...
 */
class MageWorx_SeoSuite_Model_Richsnippet_Catalog_Product_Meta_Manufacturer extends MageWorx_SeoSuite_Model_Richsnippet_Catalog_Product_Abstract
{
    protected function _addAttributeForNodes(simple_html_dom_node $node)
    {
        $attributeCode = Mage::helper('seosuite/richsnippet')->getManufacturerAttributeCode();
        if($attributeCode){
            $manufacturerValue = Mage::helper('seosuite/richsnippet')->getAttributeValueByCode($this->_product, $attributeCode);

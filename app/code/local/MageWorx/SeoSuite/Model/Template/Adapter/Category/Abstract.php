        ...
        foreach ($catigories as $_category) {
            foreach ($stores as $store) {
                ...
                foreach ($attributes as $attribute) {
                    ...
                    if ($row) {
                        $connection->update($tablePrefix . 'catalog_category_entity_' . $attribute['backend_type'],
                        ...
                        $connection->insert($tablePrefix . 'catalog_category_entity_' . $attribute['backend_type'],
                                $data);
                    }
                }
            }

...
class MageWorx_SeoSuite_Model_Template extends Mage_Core_Model_Abstract
{
    ...
    {
        $storeDataAll  = $this->getStoreData();
        $storeData  = $storeDataAll['store_template'];
        ...
        if(!empty($storeDataAll['change_store']) && $storeDataAll['change_store'] == 'yes'){
            if(!empty($storeDataAll['change_entity']) && $storeDataAll['change_entity'] == 'yes'){
                if (!$storeModel->getEntityId()) {
                    unset($storeModel);
                    $storeModel = Mage::getModel('seosuite/template_store');
                }
                $storeModel = Mage::getModel('seosuite/template_store')->load($storeDataAll['entity_new']);
            }else{
                $storeModel = Mage::getModel('seosuite/template_store');
            }
        }

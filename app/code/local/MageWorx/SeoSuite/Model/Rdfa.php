                ...
                "gr:hasPriceSpecification"    => array(
                    ...
                    'childs' => array(
                        ...
                        'gr:UnitPriceSpecification' => array(
                            'tag'    => 'typeof',
                            'childs' => array(
                                'gr:valueAddedTaxIncluded' => array('tag' => 'property', 'datatype' => 'xsd:boolean',
                                    'format'   => 'boolean'),
                                'gr:getPrice'  => array('tag' => 'property', 'datatype' => 'xsd:float',
                                    'format'   => 'float'),
                                'gr:hasCurrency' => array('tag' => 'property', 'datatype' => 'xsd:string',
                                    'format'   => 'string'),
                            )
                        )
                    )
                                ...
                                'gr:typeOfGood'       => array('tag' => 'rel',
                                    'childs' => array(
                                        'gr:SomeItems' => array(
                                            'tag'    => 'typeof',
                                            'childs' => array(
                                                'gr:name'                => array('tag' => 'property', 'xml:lang' => '',
                                                    'format'   => 'language'),
                                                'gr:description'         => array('tag' => 'property', 'xml:lang' => '',
                                                    'format'   => 'language'),
                                                'gr:hasStockKeepingUnit' => array('tag' => 'property', 'datatype' => 'xsd:string',
                                                    'format'   => 'string'),
                                                'gr:color'               => array('tag' => 'property', 'xml:lang' => '',
                                                    'format'   => 'language'),
                                                'gr:hasManufacturer'     => array('tag' => 'rel', 'xml:lang' => '',
                                                    'format'   => 'language'),
                                                'gr:category'            => array('tag' => 'property', 'xml:lang' => '',
                                                    'format'   => 'language'),
    ...
    private function _generate($key, $item)
    {
        ...
        switch ($item['tag']) {
            ...
            case 'typeof':
                list($type, $sKey) = explode(":", $key);
                $url     = explode('?',
                        Mage::getModel('core/url')->getUrl('*/*/*', array('_current'     => true, '_use_rewrite' => true))); //fix
    ...
    public function _getItemValue($key)
    {
        ...
        switch ($sKey) {
            ...
            case 'depiction':
                ...
                break;
            case 'availability':
                $value = (float) $product->getStockItem()->getMinSaleQty() ? (float) $product->getStockItem()->getMinSaleQty()
                            : $product->isInStock() ? Mage::helper('seosuite')->__('In stock') : Mage::helper('seosuite')->__('Out of stock');
                break;
            case 'hasMinValue':
                $value = (float) $product->getStockItem()->getMinSaleQty() ? (float) $product->getStockItem()->getMinSaleQty()
            ...
            case 'offerurl':
                ...
                break;
            case 'rating':
                $value = $ratingData['rating_summary'];

                ...
                switch ($attribute) {
                    ...
                    case 'price':
                        ...
                        elseif ($product->getTypeId() == 'grouped') {
                            ...
                            if ($product->getPrice() > 0) {
                                ...
                                $value = Mage::app()->getStore($product->getStore()->getId())->convertPrice($price,
                                        false, false);
                    ...
                    case 'special_price':
                        if ($product->getSpecialPrice() > 0) {
                            ...
                            $value = Mage::app()->getStore($product->getStore()->getId())->convertPrice($price, false,
                                    false);
                            //     $value = Mage::helper('core')->currency($value,true,FALSE);
                        }
                        break;

...
$installer->run("
INSERT IGNORE INTO `{$this->getTable('seosuite_template')}` (`template_code`, `template_name`, `comment`) VALUES
...
");
$string    = "INSERT IGNORE INTO `{$this->getTable('seosuite_template_store')}` (`entity_id`, `template_id`, `store_id`, `template_key`,`last_update`) VALUES";
$listQuery = array();
...
$installer->updateAttribute('catalog_product', 'meta_keyword', 'note',
    'Leave blank to use Product Meta Keywords Template');

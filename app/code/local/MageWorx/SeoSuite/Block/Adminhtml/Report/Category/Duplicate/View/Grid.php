 ...
 */
class MageWorx_Seosuite_Block_Adminhtml_Report_Category_Duplicate_View_Grid extends Mage_Adminhtml_Block_Widget_Grid
{
    ...
    protected function _prepareCollection()
    {
        ...
        $collection = Mage::getResourceModel('seosuite/report_category_collection')->addFieldToFilter('store_id',
                $store->getId());

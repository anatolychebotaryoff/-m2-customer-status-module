...
class MageWorx_Seosuite_Block_Adminhtml_Report_Grid_Renderer_Error extends Mage_Adminhtml_Block_Widget_Grid_Column_Renderer_Abstract
{
    ...
    public function render(Varien_Object $row)
    {
        ...
        switch ($index) {
            case 'meta_title_error':
                ...
                if ($row->getData('meta_title_len') > Mage::helper('seosuite/report')->getMaxLengthMetaTitle() && isset($values['long'])){
            ...
            case 'meta_descr_error':
                ...
                if ($row->getData('meta_descr_len') > Mage::helper('seosuite/report')->getMaxLengthMetaDescription() && isset($values['long'])){

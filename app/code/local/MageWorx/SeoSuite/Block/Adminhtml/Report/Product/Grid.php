 ...
 */
class MageWorx_Seosuite_Block_Adminhtml_Report_Product_Grid extends Mage_Adminhtml_Block_Widget_Grid
{
    ...
    public function __construct()
    {
        ...
        if (!Mage::registry('error_types')) Mage::register('error_types', Mage::helper('seosuite/report')->getErrorTypes());
    }

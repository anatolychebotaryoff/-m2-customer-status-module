 ...
 */
class MageWorx_Seosuite_Block_Adminhtml_Report_Cms_Grid extends Mage_Adminhtml_Block_Widget_Grid
{
    ...
    protected function _prepareColumns()
    {
        ...
        $this->addColumn('heading_error',
            ...
            'type'     => 'options',
            'options'  => Mage::helper('seosuite/report')->getErrorTypes(array('missing', 'duplicate')),
        ...
        $this->addColumn('meta_title_error',
            ...
            'filter'   => 'seosuite/adminhtml_report_grid_filter_error',
            'type'     => 'options',
            'options'  => Mage::helper('seosuite/report')->getErrorTypes(array('long', 'duplicate')),

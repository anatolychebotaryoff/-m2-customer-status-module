...
//        echo $this->_select->assemble(); exit;
        ...
        if ($onlyCount) {
            ...
            $count_sel = $read->select()
              ->from($this->_select, 'COUNT(*)');
            $count =  $read->fetchOne($count_sel);
            //Mage::log($count, null, "sitemap_xml-count.log");
            //Mage::log($count_sel->__toString(), null, "sitemap_xml-count.log");
            return $count;

...
class CapacityWebSolutions_NavigationMenuPro_Adminhtml_MenudataController extends Mage_Adminhtml_Controller_Action
{
	...
	echo $Parent_item = Mage::getModel("navigationmenupro/menucreator")->getParentItems($groupId,$current_menu_id);
	}
	...
	$groupId = $this->getRequest()->getParam('group_id');
	$current_menu_id = $this->getRequest()->getParam('current_menu');
	echo $Parent_item = Mage::getModel("navigationmenupro/menucreator")->getAddSubParentItems($groupId,$current_menu_id);
	}
